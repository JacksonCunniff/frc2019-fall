...
public class DrivesWithJoysticks extends Command {
 // private double leftSpeed;
  ...
  protected void execute() {
    ...
    left2Speed =  OI.getController().getY(Hand.kLeft); /* positive is forward */
    rightSpeed =  OI.getController().getY(Hand.kRight); 
   ...
   left2Speed*=.8;
   rightSpeed*=.805;
   if(OI.getController().getTriggerAxis(Hand.kRight) > 0.05){
    left2Speed*=.75;
    rightSpeed*=.75;
   }
